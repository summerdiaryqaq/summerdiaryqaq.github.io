...
Ammo().then((Ammo) => {
    ...
    function loadRyanText() {
        ...
        text_loader.load('./src/jsm/Poppins_Regular.json', function(font) {
            ...
            var geometry = new THREE.TextGeometry("Xevier", {
                font: font,
                size: 4,
                height: 0.5,
                curveSegments: 12,
    ...
    function loadEngineerText() {
        ...
        text_loader.load('./src/jsm/Poppins_Regular.json', function(font) {
            ...
            var geometry = new THREE.TextGeometry('Life was like a box of chocolate', {
                font: font,
                size: 1.5,
                height: 0.5,
                curveSegments: 20,
    ...
    function start() {
        ...
        // 浮动文字
        floatingLabel(11.875, 4.5, -70, 'Tik Tok');
        floatingLabel(19.125, 4.5, -70, 'BiliBili');
        floatingLabel(26.875, 4.5, -70, 'KUAISHOU');
        floatingLabel(36, 4.5, -70, 'XiaoHongShu');
        ...
        // 板块文字
        simpleText(-50, 0.01, -5, 'PICTURES', 3);
